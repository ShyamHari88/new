...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const currentTab = activeTab; // Capture current state to avoid closure issues
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="identifier" className="text-sm font-medium text-foreground">
                      {activeTab === 'student' ? 'Roll Number' : activeTab === 'teacher' ? 'Teacher ID' : 'Email Address'}
                    </label>
                    <div className="relative">
                      ...
                      <Input
                        id="identifier"
                        type="text"
                        placeholder={activeTab === 'student' ? "23IT151" : activeTab === 'teacher' ? "TCH001" : "admin@college.edu"}
                        value={identifier}
